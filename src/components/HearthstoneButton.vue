...
const onClick = () => emit('hearthstone-button-clicked');
...
<template>
   <div :class="['hs-wrapper', variant]">
    <a :class="['hs-button', variant]" @click="onClick">
      <span :class="['hs-border', variant]">
        <span :class="['hs-text', variant]">
          {{ label }}
        </span>
      </span>
    </a>
